...
public interface IProfileStatusController {
    ...
    @Operation(summary = "Returns the status profile iterable", description = CategoryRestConstant.CATEGORY_GENERAL_DESCRIPTION, tags = {CategoryRestConstant.CATEGORY_GENERAL})
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
                    content = @Content(schema = @Schema(implementation = ProfileStatusDto.class))),
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
    ...
    @Operation(summary = "Returns the status profile by id", description = CategoryRestConstant.CATEGORY_GENERAL_DESCRIPTION, tags = {CategoryRestConstant.CATEGORY_GENERAL})
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
    ...
    @Operation(summary = "Returns the status profile by uuId", description = CategoryRestConstant.CATEGORY_GENERAL_DESCRIPTION, tags = {CategoryRestConstant.CATEGORY_GENERAL})
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
    ...
    @Operation(summary = "Returns the status profile created", description = CategoryRestConstant.CATEGORY_GENERAL_DESCRIPTION, tags = {CategoryRestConstant.CATEGORY_GENERAL})
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
    ...
    Mono<ResponseEntity<Object>> doOnCreateExecute(ProfileStatusDto dto);

    @Operation(summary = "Returns the status profile updated", description = CategoryRestConstant.CATEGORY_GENERAL_DESCRIPTION, tags = {CategoryRestConstant.CATEGORY_GENERAL})
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Successful operation",
    ...
    Mono<ResponseEntity<Object>> doOnUpdateExecute(ProfileStatusDto dto);
