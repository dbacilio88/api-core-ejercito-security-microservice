...
public class ProfileStatusController extends ReactorControllerBase implements IProfileStatusController {
    private final IProfileStatusDomainService service;

    public ProfileStatusController(Response response, IProfileStatusDomainService service) {
        super(response, "ProfileStatusController");
        this.service = service;
    }


    @Override
    @GetMapping(path = FIND_ALL_PROFILE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @GetMapping(path = FIND_BY_ID_PROFILE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @GetMapping(path = FIND_BY_UUID_PROFILE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @Override
    @PostMapping(path = CREATE_PROFILE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    public Mono<ResponseEntity<Object>> doOnCreateExecute(@RequestBody @Valid ProfileStatusDto dto) {
    ...
    @Override
    @PutMapping(path = UPDATE_PROFILE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
    public Mono<ResponseEntity<Object>> doOnUpdateExecute(@RequestBody @Valid ProfileStatusDto dto) {
    ...
    @Override
    @DeleteMapping(path = DELETE_PROFILE_STATUS_PATH, produces = MediaType.APPLICATION_JSON_VALUE)
